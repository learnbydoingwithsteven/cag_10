...
app = FastAPI(title="News Fact Checker API")
...
async def process_query(request: QueryRequest):
    """Process query using Multi-source CAG"""
    try:
        ...
        prompt = f"""You are a news fact checker. Process the following query:
...
Provide a comprehensive response."""
        ...
        return QueryResponse(
            ...
            response=response,
            context=context,
            metadata={"model": "llama3", "technique": "Multi-source CAG"},
