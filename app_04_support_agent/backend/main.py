...
Conversational CAG with Memory
"""
...
async def process_query(request: QueryRequest):
    """Process query using Conversational CAG with Memory"""
    try:
        ...
        prompt = f"""You are a customer support agent. Process the following query:
...
Provide a comprehensive response."""
        ...
        return QueryResponse(
            ...
            response=response,
            context=context,
            metadata={"model": "llama3", "technique": "Conversational CAG with Memory"},
