"""
E-commerce Product Recommender Backend
Hybrid CAG
"""
...
async def root():
    return {
        "app": "E-commerce Product Recommender",
...
async def process_query(request: QueryRequest):
    """Process query using Hybrid CAG"""
    try:
        ...
        prompt = f"""You are a e-commerce product recommender. Process the following query:
...
Provide a comprehensive response."""
        ...
        return QueryResponse(
            ...
            response=response,
            context=context,
            metadata={"model": "llama3", "technique": "Hybrid CAG"},
