...
async def process_query(request: QueryRequest):
    """Process query using Structured Data CAG"""
    try:
        ...
        prompt = f"""You are a financial report analyzer. Process the following query:
...
Provide a comprehensive response."""
        ...
        return QueryResponse(
            ...
            response=response,
            context=context,
            metadata={"model": "llama3", "technique": "Structured Data CAG"},
